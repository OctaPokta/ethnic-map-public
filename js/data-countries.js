...
window.DashboardData.countries = {
    Iran: {
        ...
        demographics: [
            ...
            { name: "טורקמנים", percent: 2, color: "#84cc16", image: "images/ethnicities/turkmens.webp", desc: "קבוצה ממוצא טורקי החיה בצפון-מזרח איראן, קרוב לגבול עם טורקמניסטן. שומרים על מסורות ייחודיות ורבים מהם חיים באורח חיים נוודי למחצה.", language: "טורקמנית", religion: "אסלאם סוני" },
