    ...
    Armenia: {
      ...
      demographics: [
        ...
        { 
          name: "כורדים", 
          percent: 1.2, 
          color: "#eab308", // 🔥 Yellow (Matches Map)
        ...
        { 
          name: "רוסים", 
          percent: 0.3, 
          color: "#94a3b8", // Neutral gray (not visibly mapped)
    ...
    Azerbeijan: {
      ...
      demographics: [
        ...
        { 
          name: "לזגינים", 
          percent: 2.0, 
          color: "#b45309", // 🔥 Brown (Matches Map)
        ...
        { 
          name: "טאלישים", 
          percent: 1.5, 
          color: "#10b981", // 🔥 Green (Matches Map)
    ...
    Iraq: {
      ...
      demographics: [
        { 
          name: "ערבים", 
          percent: 78, 
          color: "#22c55e", // 🔥 Green (Matches Map)
    ...
    Israel: {
      ...
      demographics: [
        ...
        { 
          name: "ערבים", 
          percent: 21.0, 
          color: "#4ade80", // 🔥 Green (Matches Map)
          image: "images/ethnicities/arabs.webp", 
        ...
        { 
          ...
          percent: 5.5, 
          color: "#8b5cf6", // 🔥 Purple (Matches the northern spots on the map)
    ...
    Lebanon: {
      ...
      demographics: [
        { 
          name: "ערבים (שיעים)", 
          percent: 31, 
          color: "#16a34a", // 🔥 Bright Green (Matches Map)
        ...
        { 
          name: "ערבים (סונים)", 
          percent: 31, 
          color: "#84cc16", // 🔥 Olive/Light Green (Matches Map)
        ...
        { 
          ...
          percent: 8, 
          color: "#ca8a04", // 🔥 Yellow/Brown (Matches Map)
        ...
        { 
          name: "דרוזים", 
          percent: 5, 
          color: "#a855f7", // 🔥 Purple (Matches Map)
    ...
    Syria: {
      ...
      demographics: [
        ...
        { 
          name: "עלווים", 
          percent: 15, 
          color: "#15803d", // 🔥 Dark Green (Matches Coast on Map)
        ...
        { 
          name: "כורדים", 
          percent: 10, 
          color: "#ca8a04", // 🔥 Yellow/Olive (Matches North on Map)
          image: "images/ethnicities/kurds.webp", 
        ...
        { 
          name: "דרוזים", 
          percent: 5, 
          color: "#a855f7", // 🔥 Purple (Matches South on Map)
    ...
    Turkey: {
      ...
      demographics: [
        { 
          name: "טורקים", 
          percent: 73, 
          color: "#15803d", // 🔥 Dark Green (Matches Map)
        ...
        { 
          name: "כורדים", 
          percent: 19, 
          color: "#ca8a04", // 🔥 Yellow/Olive (Matches Map)
          image: "images/ethnicities/kurds.webp", 
        ...
        { 
          name: "בני זאזא", 
          percent: 4, 
          color: "#5eead4", // 🔥 Teal/Light Blue (Matches Map)
        ...
        { 
          ...
          percent: 1.5, 
          color: "#22c55e", // 🔥 Bright Green (Matches Map)
          image: "images/ethnicities/azeris.webp", 
        ...
        { 
          name: "לאזים", 
          percent: 0.5, 
          color: "#db2777", // 🔥 Pink/Magenta (Matches Map)
