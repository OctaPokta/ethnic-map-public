const DashboardData = {
  ...
  countries: {
    ...
    Azerbeijan: {
      ...
      demographics: [
        { name: "אזרים", percent: 91.6, color: "#10b981", image: "images/ethnicities/azeris.webp" },
        { name: "לזגינים", percent: 2.0, color: "#f59e0b", image: "images/ethnicities/lezgins.webp" },
        { name: "ארמנים", percent: 1.3, color: "#3b82f6", image: "images/ethnicities/armenians.webp" },
        { name: "רוסים", percent: 1.3, color: "#ef4444", image: "images/ethnicities/russians.webp" }
      ]
    },
    Iran: {
      hebrewName: "איראן",
      ...
      demographics: [
        { name: "פרסים", percent: 61, color: "#0ea5e9", image: "images/ethnicities/persians.webp" },
        { name: "אזרים", percent: 16, color: "#ef4444", image: "images/ethnicities/azeris.webp" },
        { name: "כורדים", percent: 10, color: "#eab308", image: "images/ethnicities/kurds.webp" },
        { name: "לורים", percent: 6, color: "#8b5cf6", image: "images/ethnicities/lurs.webp" },
        { name: "בלוצ'ים", percent: 2, color: "#d97706", image: "images/ethnicities/baloch.webp" }
      ]
    },
    Iraq: {
      hebrewName: "עיראק",
      ...
      demographics: [
        { name: "ערבים", percent: 78, color: "#22c55e", image: "images/ethnicities/arabs.webp" },
        { name: "כורדים", percent: 18, color: "#eab308", image: "images/ethnicities/kurds.webp" },
        { name: "טורקמנים ואשורים", percent: 4, color: "#6366f1", image: "images/ethnicities/turkmens.webp" }
      ]
    },
    Israel: {
      hebrewName: "ישראל",
      ...
      demographics: [
        { name: "יהודים", percent: 73.5, color: "#3b82f6", image: "images/ethnicities/jews.webp" },
        { name: "ערבים", percent: 21.0, color: "#22c55e", image: "images/ethnicities/arabs.webp" },
        { name: "אחרים", percent: 5.5, color: "#8b5cf6", image: "images/ethnicities/others.webp" }
      ]
    },
    Jordan: {
      hebrewName: "ירדן",
      ...
      demographics: [
        { name: "ערבים", percent: 98, color: "#22c55e", image: "images/ethnicities/arabs.webp" },
        { name: "צ'רקסים", percent: 1, color: "#f43f5e", image: "images/ethnicities/circassians.webp" },
        { name: "ארמנים", percent: 1, color: "#3b82f6", image: "images/ethnicities/armenians.webp" }
      ]
    },
    Kuwait: {
      hebrewName: "כוויית",
      ...
      demographics: [
        { name: "אסייתים", percent: 40.3, color: "#8b5cf6", image: "images/ethnicities/asians.webp" },
        { name: "כוויתים", percent: 30.4, color: "#22c55e", image: "images/ethnicities/kuwaitis.webp" },
        { name: "ערבים אחרים", percent: 27.4, color: "#10b981", image: "images/ethnicities/arabs.webp" }
      ]
    },
    Lebanon: {
      hebrewName: "לבנון",
      ...
      demographics: [
        { name: "ערבים", percent: 95, color: "#22c55e", image: "images/ethnicities/arabs.webp" },
        { name: "ארמנים", percent: 4, color: "#3b82f6", image: "images/ethnicities/armenians.webp" },
        { name: "אחרים", percent: 1, color: "#f59e0b", image: "images/ethnicities/others.webp" }
      ]
    },
    SaudiArabia: {
      ...
      demographics: [
        { name: "סעודים", percent: 58.4, color: "#22c55e", image: "images/ethnicities/saudis.webp" },
        { name: "לא-סעודים", percent: 41.6, color: "#64748b", image: "images/ethnicities/others.webp" }
      ]
    },
    Syria: {
      hebrewName: "סוריה",
      ...
      demographics: [
        { name: "ערבים", percent: 50, color: "#22c55e", image: "images/ethnicities/arabs.webp" },
        { name: "עלווים", percent: 15, color: "#ec4899", image: "images/ethnicities/alawites.webp" },
        { name: "אחרים", percent: 15, color: "#64748b", image: "images/ethnicities/others.webp" },
        { name: "כורדים", percent: 10, color: "#eab308", image: "images/ethnicities/kurds.webp" },
        { name: "לבנטינים", percent: 10, color: "#3b82f6", image: "images/ethnicities/levantines.webp" }
      ]
    },
    Turkey: {
      hebrewName: "טורקיה",
      ...
      demographics: [
        { name: "טורקים", percent: 73, color: "#ef4444", image: "images/ethnicities/turks.webp" },
        { name: "כורדים", percent: 19, color: "#eab308", image: "images/ethnicities/kurds.webp" },
        { name: "אחרים", percent: 8, color: "#64748b", image: "images/ethnicities/others.webp" }
      ]
    }
  },
